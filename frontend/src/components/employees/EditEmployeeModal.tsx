...
export default function EditEmployeeModal({ open, onOpenChange, employee, onSubmit }: EditEmployeeModalProps) {
        ...
        <form onSubmit={form.handleSubmit(onSubmitForm)}>
          <div className="grid gap-6 py-4">
            ...
            <div className="border-t pt-4">
              <h3 className="font-semibold text-gray-900 mb-3">Replace Documents</h3>
