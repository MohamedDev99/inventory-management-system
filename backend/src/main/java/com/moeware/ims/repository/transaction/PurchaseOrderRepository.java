...
public interface PurchaseOrderRepository extends JpaRepository<PurchaseOrder, Long> {
        ...
        /**
         * Count purchase orders by status and actual delivery date.
         * Used to count POs received on a specific date for the dashboard activity
         * summary.
         */
        long countByStatusAndActualDeliveryDate(PurchaseOrderStatus status, LocalDate actualDeliveryDate);
}