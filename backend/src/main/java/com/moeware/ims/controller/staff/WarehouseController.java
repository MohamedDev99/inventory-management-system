...
public class WarehouseController {
        ...
        public ResponseEntity<ApiResponseWpp<WarehouseResponse>> createWarehouse(
                        @Valid @RequestBody WarehouseCreateRequest request) {
                log.info("REST request to create warehouse: {}", request.getCode());
                WarehouseResponse response = warehouseService.createWarehouse(request);
                return ResponseEntity.status(HttpStatus.CREATED)
                                .body(ApiResponseWpp.success(response, "Warehouse created successfully"));
        }
        ...
        public ResponseEntity<ApiResponseWpp<WarehouseResponse>> getWarehouseById(
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(response, "Warehouse found"));
        }
        ...
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'WAREHOUSE_STAFF', 'VIEWER')")
        public ResponseEntity<ApiResponseWpp<WarehouseResponse>> getWarehouseByCode(
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(response, "Warehouse found by code {}"));
        }
        ...
        @GetMapping
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'WAREHOUSE_STAFF', 'VIEWER')")
        public ResponseEntity<ApiResponseWpp<Page<WarehouseResponse>>> getAllWarehouses(
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(warehouses, "Warehouses retrieved successfully"));
        }
        ...
        @GetMapping("/active")
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'WAREHOUSE_STAFF', 'VIEWER')")
        public ResponseEntity<ApiResponseWpp<List<WarehouseResponse>>> getAllActiveWarehouses() {
                ...
                return ResponseEntity
                                .ok(ApiResponseWpp.success(warehouses, "Active warehouses retrieved successfully"));
        }
        ...
        public ResponseEntity<ApiResponseWpp<Page<WarehouseResponse>>> getWarehousesByManager(
        ...
        public ResponseEntity<ApiResponseWpp<WarehouseStatsResponse>> getWarehouseStatistics(
                        @Parameter(description = "Warehouse ID", required = true) @PathVariable Long id) {
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(stats, "Warehouse Statistics retrieved successfully"));
        }
        ...
        @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'WAREHOUSE_STAFF')")
        public ResponseEntity<ApiResponseWpp<List<WarehouseResponse>>> getWarehousesWithLowStock() {
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(warehouses,
                                "Warehouses with low stock alerts retrieved successfully"));
        }
        ...
        public ResponseEntity<ApiResponseWpp<WarehouseResponse>> updateWarehouse(
                        @Parameter(description = "Warehouse ID", required = true) @PathVariable Long id,
                ...
                return ResponseEntity.ok(ApiResponseWpp.success(response, "Warehouse updated successfully"));
        }
        ...
        @PatchMapping("/{id}")
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponseWpp<WarehouseResponse>> patchWarehouse(
                        @Parameter(description = "Warehouse ID", required = true) @PathVariable Long id,
        ...
        @DeleteMapping("/{id}")
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponseWpp<Void>> deleteWarehouse(
                        @Parameter(description = "Warehouse ID", required = true) @PathVariable Long id) {

                log.info("REST request to soft delete warehouse: {}", id);
                warehouseService.deleteWarehouse(id);
                return ResponseEntity.status(HttpStatus.NO_CONTENT)
                                .body(ApiResponseWpp.success(null, "Warehouse deactivated successfully"));
        }
        ...
        public ResponseEntity<ApiResponseWpp<Long>> getWarehouseCount(
                        @Parameter(description = "Filter by active status", example = "true") @RequestParam(required = false) Boolean isActive) {

                log.debug("REST request to get warehouse count");
                long count = warehouseService.countWarehouses(isActive);
                return ResponseEntity.ok(ApiResponseWpp.success(count, "Warehouse count retrieved successfully"));
        }
}