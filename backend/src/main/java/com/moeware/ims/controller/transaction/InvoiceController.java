...
public class InvoiceController {
        ...
        public ResponseEntity<ApiResponseWpp<InvoiceResponse>> generateInvoice(
                        ...
                        @Parameter(description = "ID of the user generating this invoice — typically a sales rep or manager") @RequestParam Long generatedByUserId) {
        ...
        public ResponseEntity<ApiResponseWpp<InvoiceResponse>> recordPayment(
                        ...
                        @Parameter(description = "ID of the user recording this payment against the invoice") @RequestParam Long processedByUserId) {
                return ResponseEntity.ok(ApiResponseWpp.success(
